...
// except for the ones that make the content appear under the system bars.
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case (R.id.btn_switch):
                    if (mCameraSource != null) {
                        Log.d("RES", "CAMERA SWITCH THIS IS A LOG TEST");
    ...
    final CameraSource.PictureCallback cameraSourcePictureCallback = new CameraSource.PictureCallback() {
        ...
        public void onPictureTaken(Bitmap picture) {
            ...
            try {
                ...
                Log.d("RES", "Screenshot Height: " + screenshot.getHeight());
                Log.d("RES", "Screenshot Width: " + screenshot.getWidth());
                ...
                mat.postRotate(270);
                Bitmap scaledBitmap = Bitmap.createScaledBitmap(screenshot, screenshot.getWidth(), screenshot.getHeight(), true);
                ...
                picture = getResizedBitmap(screenshot, picture);
                ...
                screenshot = overlay(picture,rotatedBitmap);
    ...
    public Bitmap getResizedBitmap(Bitmap image, Bitmap scaledImage) {
        int width = image.getHeight();
        int height = image.getWidth();
        return Bitmap.createScaledBitmap(scaledImage, width, height, true);
    }
    ...
    private void createCameraSource(FaceDetector detector) {
       ...
       // width = (float)metrics.widthPixels;
        Log.d("RES", "Height " + height);
        Log.d("RES", "Width " + width);
